        ...
        with ExitStack() as stack:
            ...
            for dt, action in self.clock:
                if action == BAR:
                    ...
                    # The discrenpency is that the minute_end generated by clock(MinuteSimulationClock) will contain all minutes from trading start to trading end, the intra day break will not be excluded.
                    # The problem is that the handle_benchmark and performance will also consider the intra day events, resulting in invilid data.
                    # There is different alternative to solve it.
                    # 1. Change MinuteSimulationClock to generate minute bar according to calendar, joint calendar will also fail
                    # 2. Change bechmark_source to fill the gap, in this case the mid day break will be analyzed.
